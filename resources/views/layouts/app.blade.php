            ...
            <div class="container">
              ...
              @if (Auth::user()->admin)
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Settings</a>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <a class="dropdown-item" href="{{route('user.create')}}">Create Users</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">something else here</a>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Tag</a>
