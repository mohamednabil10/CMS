			...
			<div id="hot-post" class="row hot-post">
				<div class="col-md-8 hot-post-left">
					...
					<div class="post post-thumb">
						<a class="post-img" href="{{ route('post.show',['slug'=>$first_post->slug]) }}"><img src="{{ $first_post->featured }}" alt="" height="350" width="350"> </a>
						<div class="post-body">
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="row">
						...
						<!-- post -->
                        @foreach ($php->posts()->orderBy('created_at','desc')->take(2)->get() as $post )
						<div class="col-md-6">
							<div class="post">
						...
						<!-- post -->
                        @foreach ($html->posts()->orderBy('created_at','desc')->take(2)->get() as $post )
						<div class="col-md-6">
							<div class="post">
								<a class="post-img" href="{{ route('post.show',['slug'=>$post->slug]) }}"><img src="{{ $post->featured }}" alt=""></a>
								<div class="post-body">
					...
					<div class="row">
						...
						<!-- post -->
                        @foreach ($cs->posts()->orderBy('created_at','desc')->take(3)->get() as $post )
						<div class="col-md-4">
							<div class="post post-sm">
								<a class="post-img" href="{{ route('post.show',['slug'=>$post->slug]) }}"><img src="{{ $post->featured }}" alt=""></a>
								<div class="post-body">
				...
				<div class="col-md-4">
					...
					<div class="aside-widget">
						...
						<div class="post post-widget">
							...
							<div class="post-body">
								<div class="post-category">
									<a href="{{ route('category.show',['id'=>$post->category->id]) }}">Lifestyle</a>
								</div>
						...
						<div class="post post-widget">
							...
							<div class="post-body">
								<div class="post-category">
									<a href="{{ route('category.show',['id'=>$post->category->id]) }}">Technology</a>
									<a href="{{ route('category.show',['id'=>$post->category->id]) }}">Lifestyle</a>
								</div>
			...
			<div class="row">
				<div class="col-md-4">
					...
					<div class="post">
						...
						<div class="post-body">
							<div class="post-category">
								<a href="{{ route('category.show',['id'=>$post->category->id]) }}">Fashion</a>
								<a href="{{ route('category.show',['id'=>$post->category->id]) }}">Lifestyle</a>
							</div>
				...
				<div class="col-md-4">
					...
					<div class="post">
						...
						<div class="post-body">
							<div class="post-category">
								<a href="{{ route('category.show',['id'=>$first_post->category->id]) }}">Lifestyle</a>
							</div>
